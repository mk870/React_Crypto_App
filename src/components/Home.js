  ...
  return (
    <HomeStyles colors = {colors(theme)}>
      <div className="stats">
        ...
        {coinsInfo && !error && news && <div className="grid">
          <div className="stat">
      ...
      {coinsInfo && !error && news && <div className='topcrypto'>
        <div className="head">
          <h3>Top 8 Crypto Currencies In The World</h3>
          <span onClick={()=>navigate('/cryptocurrencies')}>Show more...</span>
        </div>
